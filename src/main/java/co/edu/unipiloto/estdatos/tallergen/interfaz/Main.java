...
import co.edu.unipiloto.estdatos.tallergen.mundo.Computador.Tipo;
...
public class Main {
    ...
    public void agregarComputador() throws Exception {
        ...
        for (int i = 0; i < tp.length; i++) {
            System.out.println("[" + (i + 1) + "] " + tp[i]);
        }

        int indice = Integer.parseInt(br.readLine());
        Tipo tipo = tp[indice - 1];
        ...
        Producto computador = new Computador(tipo,gama,precio);
